...
<section id="hero" class="bg-video">
	<div class="slider">
        <div class="slide">
			...
			<?php } ?>
            <div class="slide-info tan download blue">
                <div class="heading blue border-top">
                  <h5><?php echo $form_heading_1; ?></h5>
                  <h3><?php echo $form_heading_2; ?></h3>
                </div>
                <img src="<?php echo $download_image; ?>" alt="<?php echo $form_heading_2; ?>" />
                <div class="description">
                	<?php echo $download_description; ?>
                	<a class="button gold" href="#">Download Now</a>
                </div>
