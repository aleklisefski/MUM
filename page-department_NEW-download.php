<?php
	/*
	Template Name: Department - Download Box
	*/
...
<?php
	...
	$download_form_intro = get_field('download_form_intro');
...
<section id="page-header" class="tan landing">
    <div class="heading tan">
      <div class="container">
      	<?php if( !empty($video_heading) ) { ?>
      		<?php include (TEMPLATEPATH . '/inc/cta.php'); ?>
      	<?php } ?>
   		<h1 class="small"><?php if( !empty($optional_h1_heading_for_seo) ) { echo $optional_h1_heading_for_seo; } else { the_title(); }?></h1>
...
<section id="hero" class="bg-video overflow">
	<div class="slider">
        <div class="slide">
			...
			<?php } ?>
            <?php if( !empty($video_heading) ) { ?>
            	<h2 class="overlay"><?php echo $video_heading; ?></h2>
            <?php } else { ?>
            <div class="slide-info download blue">
                ...
                <div class="description">
                	...
                	<p><a class="button" href="#"><?php if ( !empty($download_button_text) ) { echo $download_button_text; } else { echo "Download Now"; }; ?></a></p>
                </div>
                <div class="form hidden">
                	<?php if ( !empty($download_form_intro) ) { echo $download_form_intro; } else { echo "Please sign up to download"; }; ?>
