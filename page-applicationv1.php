<?php
	/*
	Template Name: MUM Application Form
	*/
...
<section id="page-header" class="tan">
	<div class="container">
		...
		<article class="full">
			...
			<div id="breadcrumbs">
				<a class="home" href="https://www.mum.edu">Home</a>
				|
				<a class="post post-page" href="https://www.mum.edu/admissions/" title="Go to Admissions.">Admissions</a>
				|
				<a class="post post-page" href="https://www.mum.edu/apply/" title="Go to Apply Online.">Apply Online</a>
				|
				<a class="post post-page current-item" href="<?php the_permalink(); ?>" title="Go to Application Form.">Application Form</a>
			</div>
		</article>
	</div>
</section>
...
<![endif]-->
<form action="https://www.mum.edu/application-payment/" method="post" name="applic" id="applic" onsubmit="return validForm(document.applic,{'savingState':'submission'});">
...
<input type="hidden" name="appvnum" value="1" />
...
<ul class="tabs">
	...
	<li><a href="#tabs-3" onClick="_gaq.push(['_trackEvent', 'Application', 'TabClick', '3']);">3. Educational Info</a></li>
...
<fieldset>
	...
	<span class="icon plus" id="phone1plus">+</span>
	
	<div id="phone2" style="display:none;">
	<label>Daytime Telephone <span class="icon minus" id="phone2minus">&ndash;</span></label>
	<input name="phone_day" type="text" size="25" maxlength="25" />
	<span class="icon plus" id="phone2plus">+</span>
	</div>
	
	<div id="phone3" style="display:none;">
	<label>Evening Telephone <span class="icon minus" id="phone3minus">&ndash;</span></label>
...
<a id="citizenship_shadow"></a>
<div class="input">
<select name="citizenship">
<option value="" selected="selected">Select Country of Citizenship</option>
<option value="U">USA citizen</option>
<option value="P">U.S. Permanent Resident (Green Card holder)</option>
<option value="I">International (citizen of any country except USA)</option>
</select>
</div>
...
<p class="radio">
	<label><input name="visa" type="radio" value="Y" onclick="makeVisible('visadiv');restyleOneSelectMenuInApp(da.visa_type);" />Yes</label>&nbsp;&nbsp;
...
<span class="icon plus" id="cma_addr1plus">+</span>
<div class="clearFix"></div>
<div id="cma_addr2" style="display:none;">
<label>Street Address 2 <span class="icon minus" id="cma_addr2minus">&ndash;</span></label>
...
<div id="cma_stateprovuscan" style="display:none;">
...
</div><!-- id="cma_stateprovuscan" -->

<div id="cma_stateprovnotuscan" style="display:none;">
<div class="clearFix"></div>
...
<fieldset>
	<label><u>Current</u> address is valid until:<span>(mm/dd/yyyy)</span></label>
	...
	<p class="radio">
		<label><input name="address_same" type="radio" value="Y" onclick="doPermAddress('Y');" />Yes</label>&nbsp;&nbsp;
...
<span class="icon plus" id="perm_addr1plus">+</span>
<div class="clearFix"></div>
<div id="perm_addr2" style="display:none;">
<label>Street Address 2 <span class="icon minus" id="perm_addr2minus">&ndash;</span></label>
...
<div id="perm_stateprovuscan" style="display:none;">
<label>* State/Province<br><span>(USA or Canada)</span></label>
...
</div><!-- id="perm_stateprovuscan" -->

<div id="perm_stateprovnotuscan" style="display:none;">
<div class="clearFix"></div>
<label>* State/Province/Region<br><span>(NOT U.S. or Canada)</span></label>
<input name="perm_state_other" type="text" class="size20 inputtextinline" size="20" maxlength="20" />
</div><!-- id="perm_stateprovnotuscan" -->
...
<label>* Degree you are applying for</label>
<a id="degree_plan_shadow"></a>
<div class="input">
<select name="degree_plan">
<option value="" selected="selected">Select Degree you are applying for</option>
...
<div id="MBAAP_dialog" class="padding" title="MBA for Accounting Professionals"><p>If you are applying for the MBA for Accounting Professionals,<br>you must first complete the Preliminary Assessment at</p></p><a href="https://portals.mum.edu/business/mba/accounting-pros/assessment" target="_blank">https://portals.mum.edu/business/mba/accounting-pros/assessment</a>.</p><p>If you have already completed the Preliminary Assessment, close this box and continue.<br><br>Otherwise, please go to the Preliminary Assessment page and complete it now.</p></div>
...
<div id="majorlist" style="display:none;">
	<label id="majorlist_label">* Intended major</label>
<a id="major_shadow"></a>
	<div class="input">
...
<div id="enrollmentdate" style="display:none;">
<div class="clearFix"></div>
...
</div><!-- id="enrollmentdate" -->

<div class="clearFix"></div>
<label>* Select your enrollment type</label>
<a id="entry_type_shadow"></a>
<div class="input">
<select name="entry_type">
<option value="" selected="selected">-- select --</option>
<option value="N">Never enrolled in a college or university before</option>
<option value="T">Enrolled at another college or university but never attended MUM</option>
<option value="R">Attended MUM and will continue in the same degree program</option>
<option value="R1">Attended MUM and will NOT continue in the same degree program</option>
<option value="C">Currently enrolled at MUM, Fairfield</option>
<option value="C1">Currently enrolled at MUM, Beijing</option>
</select>
</div>

<div class="clearFix"></div>
<label>* How you <u>first</u> heard about MUM</label>
...
<p class="radio">
<label><input name="hs_type" type="radio" value="DIPL" onclick="makeHS('dip')" />Diploma</label>
<label><input name="hs_type" type="radio" value="HOME" onclick="makeHS('hom')" />Home school</label>
<label><input name="hs_type" type="radio" value="GED" onclick="makeHS('ged')" />GED</label>
<label><input name="hs_type" type="radio" value="OTH" onclick="makeHS('oth')" />Other</label>
</p>
...
<p class="radio">
	<label><input name="have_degree" type="radio" value="Y" onclick="makeVisible('higher');makeInvisible('id_have_attended_after_high_school');" />Yes</label>&nbsp;&nbsp;
	<label><input name="have_degree" type="radio" value="N" onclick="makeInvisible('higher');makeVisible('id_have_attended_after_high_school');do_click('have_attended_after_high_school');" />No</label>
</p>
</div><!-- id="degree" -->

<div id="id_have_attended_after_high_school" style="display:none;">
<label class="labelfullwidth">* Have you attended any Educational Institution After High School?</label>
<p class="radio">
	<label><input name="have_attended_after_high_school" type="radio" value="Y" onclick="makeVisible('higher');" />Yes</label>&nbsp;&nbsp;
	<label><input name="have_attended_after_high_school" type="radio" value="N" onclick="makeInvisible('higher');" />No</label>
</p>
</div><!-- id="id_have_attended_after_high_school" -->
</fieldset>
...
<div id="gre" style="display:none;">
	...
	<p class="radio">
		<label><input name="exam" type="radio" value="NONE" />None</label>
		<label><input name="exam" type="radio" value="GMAT" />GMAT</label>
...
<p class="radio">
	<label><input name="fin_aid" type="radio" value="Y" />Yes</label>&nbsp;&nbsp;
...
<div id="file_fafsa_tr" style="display:none;">
	...
	<p class="radio">
		<label><input name="file_fafsa" type="radio" value="Y" />Yes</label>&nbsp;&nbsp;
...
<p class="radio">
	<label><input name="acdmprob" type="radio" value="Y" onclick="makeVisible('acpro');" />Yes</label>&nbsp;&nbsp;
...
<!--
	...
	<p class="radio">
		<label><input name="drugs" type="radio" value="Y" onclick="makeVisible('drug');" />Yes</label>&nbsp;&nbsp;
...
-->
	...
	<p class="radio">
		<label><input name="crime" type="radio" value="Y" onclick="makeVisible('divcrime_details');" />Yes</label>&nbsp;&nbsp;
...
<fieldset>
	<div id="tmc">
		...
		<div id="tminfo" style="display:none;">
			...
			<p class="radio">
				<label><input name="sidha" type="radio" value="No" onclick="makeInvisible('sidhas');" />No</label>&nbsp;&nbsp;
...
<option value="12">December</option>
			...
			<p class="radio">
				<label><input name="msaey" type="radio" value="Y" onclick="msaeHelper('Yes');" />Yes</label>&nbsp;&nbsp;
...
<!--
		...
		<p class="radio">
			<label><input name="techniques" type="radio" value="N" onclick="makeInvisible('tech');" />No</label>&nbsp;&nbsp;
...
<fieldset>
	...
	<p class="radio">
		<label><input name="agree_info" type="radio" value="Y" />Yes</label>&nbsp;&nbsp;
...
<div id="partial_save_button">
	<p><strong>You may fill in part of the form, then return later to complete it.</strong> After you click the "Save and Continue Later" button, you will receive an email with a special link that allows you to return later and continue. Please complete at least the sections: Name, Contact Information, and Citizenship.</p>
...
<!-- ******************** JAVASCRIPT ******************** -->
<!-- No need to call setMajor.js, because it is called as part of contact us, which is on every page, including the application form. Otherwise it would be called twice. -->
<!-- <script src="/js/setMajorv1.js" type="text/javascript"></script> -->
<script src="/js/applicationv3.js" type="text/javascript"></script>
<script src="/js/validate_appv2.js" type="text/javascript"></script>
