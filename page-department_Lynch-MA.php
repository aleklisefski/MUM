<?php
	/*
	Template Name: Department - David Lynch MA
	*/
        ...
        <div class="slide">
            ...
            <div class="slide-info download blue">
                <div class="heading blue border-top">
                  <a class="button fancybox-content desktop" href="#lynch-signup"><?php if( $download_button_text ) { echo $download_button_text; } else { echo 'Download Now'; } ?></a>
                  <h5><?php echo $form_heading_1; ?></h5>
                  <h3><?php echo $form_heading_2; ?></h3>
                  <a class="button fancybox-content mobile" href="#lynch-signup"><?php if( $download_button_text ) { echo $download_button_text; } else { echo 'Download Now'; } ?></a>
                </div>
