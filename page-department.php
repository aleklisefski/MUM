			...
			?>
				<div class="slideshow">
					<div class="slider cycle-slideshow"
						...
						data-cycle-prev=".slide-left.sub"
						data-cycle-next=".slide-right.sub"
						data-cycle-slides="> div.slide"
						data-cycle-swipe="true"
						data-cycle-pager=".slide-tabs.sub"
						>
				        ...
				        <div class="slide">
							...
							<div class="slide-info blue border-top">
								<h3><?php echo $heading; ?></h3>
								<p><?php echo $content; ?></p>
								<?php if( !empty($link) ) { ?>
									<a class="button" href="<?php echo $link; ?>"><?php if( $button_text ) { echo $button_text; } else { echo 'Learn More'; } ?></a>
								<?php } ?>
							</div>
						</div>
						<?php endwhile; ?>
					...
					<?php if( $rows != 1 ) { ?>
						<a class="slide-left sub" href="#" onClick="_gaq.push(['_trackEvent', '<?php the_title(); ?>', 'Slide Nav', 'Prev']);"></a>
						<a class="slide-right sub" href="#" onClick="_gaq.push(['_trackEvent', '<?php the_title(); ?>', 'Slide Nav', 'Next']);"></a>
					<?php } ?>
				</div>	
			<?php endif; ?>
		</article>
...
?>
<section class="<?php if( !have_rows('featured_content_boxes') ) { ?>gray<?php } ?>">
 	<div class="container">	
...
?>
<section class="<?php if( (!have_rows('featured_content_boxes') && !have_rows('circles')) OR (have_rows('featured_content_boxes') && have_rows('circles')) ) { ?>gray<?php } ?>">
 	<div class="container">
