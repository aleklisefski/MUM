...
<section id="hero" class="bg-video overflow select-interest">
	<div class="slider">
        <div class="slide">
	...
	<section class="landing_intro<?php if( $section_count % 2 != 0 ) { ?> gray<?php } ?>">
	 	<div class="container">	
	 		<article class="full">
				...
				<?php } else { ?>
					<img src="<?php echo $thumb; ?>" alt="<?php echo $alt; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>" />
					<?php if( $image_caption ) { ?><div class="caption"><?php echo $image_caption; ?></div><?php } ?>
				<?php } ?>	
		 		</div>
...
<section id="page-header" class="tan no-subnav">
 	<div class="container">	
...
<section class="body">
 	<div class="container">	
			...
			<?php endif; ?>	
 			...
 			<!-- Repeat Interest Select Options / Pop-up -->
 			<?php if(get_field('interest_select_options')): $option_count = 1 ?>
 			<div class="slide-info download blue">
                <div class="heading blue border-top">
                  <h3><?php echo $form_heading; ?></h3>
...
<?php if(get_field('interest_select_options')): $option_count = 1 ?>
	...
	<?php while(has_sub_field('interest_select_options')): ?>
		...
		<div id="<?php echo 'popup-' . $option_count ?>" class="download_popup hidden">
			...
			<div id="mc_embed_signup">
				<form action="//mum.us8.list-manage.com/subscribe/post?u=22fad1e3d15e93d858349d4a6&amp;id=<?php echo $mailchimp_form_id; ?>" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
					<input type="hidden" id="mce-SOURCE" name="SOURCE" value="<?php echo $TrafficSource; ?>" />
			    	<input type="hidden" id="mce-TYPE" name="TYPE" value="<?php echo $type; ?>" />
			    	<input type="hidden" id="mce-KEYWORD" name="KEYWORD" value="<?php echo $Keyword; ?>" />
			    	<input type="hidden" id="mce-SELECTION" name="SELECTION" value="<?php echo $select_option_label; ?>" />
					<div id="mc_embed_signup_scroll">
						...
						<div class="mc-field-group">
						    <input type="text" value="Phone Number *" name="PHONE" class="required phone clearDefault" id="mce-MMERGE3">
						</div>	
